...
cat(
	badger::badge_cran_release("allofus", "green"),
	badger::badge_cran_download("allofus", "grand-total", "green"),
	badger::badge_codecov(branch = "cran")
)
```
<!-- badges: end -->
...
The `aou_join()` function is a wrapper around the `dplyr` join functions that allows you to join tables more easily:
```{r}
person |>
