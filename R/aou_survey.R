...
aou_survey <- function(cohort = NULL,
  ...
  if (length(regular_survey_concept_ids) > 0) {
    ...
    if (isTRUE(clean_answers)) {
      ...
      concept_code_q <- "CREATE TEMP TABLE FOSPVQLIBL (
        code STRING,
        answer STRING
      ); INSERT INTO FOSPVQLIBL (value_source_value, better_answer)
      VALUES('SDOH_1', 'Strongly agree'),
      ('SDOH_2', 'Agree'),
      ('SDOH_3', 'Neutral (neither agree nor disagree)'),
      ('SDOH_4', 'Disagree'),
      ('SDOH_5', 'Strongly disagree'),
      ('SDOH_10', 'Detached single-family housing'),
      ('SDOH_11', 'Townhouses, row house, apartments, or condos of 2-3 stories'),
      ('SDOH_12', 'Mix of single-family residences and townhouses, row houses, apartments, or condos'),
      ('SDOH_13', 'Apartments or condos of 4-12 stories'),
      ('SDOH_14', 'Apartments or condos of more than 12 stories'),
      ('SDOH_6', 'Somewhat disagree'),
      ('SDOH_7', 'Somewhat agree'),
      ('SDOH_9', 'Does not apply to my neighborhood'),
      ('SDOH_15', 'None of the time'),
      ('SDOH_16', 'A little of the time'),
      ('SDOH_17', 'Some of the time'),
      ('SDOH_18', 'Most of the time'),
      ('SDOH_19', 'All of the time'),
      ('SDOH_20', 'Never'),
      ('SDOH_21', 'Rarely'),
      ('SDOH_22', 'Sometimes'),
      ('SDOH_23', 'Often'),
      ('SDOH_24', 'Almost everyday'),
      ('SDOH_25', 'At least once a week'),
      ('SDOH_26', 'A few times a month'),
      ('SDOH_27', 'A few times a year'),
      ('SDOH_28', 'Less than once a year'),
      ('SDOH_29', 'Your ancestry or national origins'),
      ('SDOH_30', 'Your gender'),
      ('SDOH_31', 'Your race'),
      ('SDOH_32', 'Your age'),
      ('SDOH_33', 'Your religion'),
      ('SDOH_34', 'Your height'),
      ('SDOH_35', 'Your weight'),
      ('SDOH_36', 'Some other aspect of your physical appearance'),
      ('SDOH_37', 'Your sexual orientation'),
      ('SDOH_38', 'Your education or income level'),
      ('SDOH_39', 'Other (specify)'),
      ('SDOH_40', 'Always'),
      ('SDOH_41', 'Often true'),
      ('SDOH_42', 'Sometimes true'),
      ('SDOH_43', 'Never true'),
      ('SDOH_44', 'Bug infestation'),
      ('SDOH_45', 'Mold'),
      ('SDOH_46', 'Lead paint or pipes'),
      ('SDOH_47', 'Inadequate heat'),
      ('SDOH_48', 'Oven or stove not working'),
      ('SDOH_49', 'No or not working smoke detector'),
      ('SDOH_50', 'Water leaks'),
      ('SDOH_51', 'None of the above'),
      ('SDOH_52', 'Almost Never'),
      ('SDOH_53', 'Fairly Often'),
      ('SDOH_54', 'Very Often'),
      ('SDOH_55', 'Many times a day'),
      ('SDOH_56', 'Every day'),
      ('SDOH_57', 'Most days'),
      ('SDOH_58', 'Some days'),
      ('SDOH_59', 'Once in a while'),
      ('SDOH_60', 'Never or almost never'),
      ('SDOH_61', 'I do not believe in God (or a higher power)'),
      ('SDOH_62', 'I am not religious'),
      ('SDOH_63', 'More than once a week'),
      ('SDOH_64', 'Once a week'),
      ('SDOH_65', '1 to 3 times per month'),
      ('SDOH_66', 'Less than once per month'),
      ('SDOH_67', 'Yes'),
      ('SDOH_68', 'No'),
      ('SDOH_70', 'Very well'),
      ('SDOH_71', 'Well'),
      ('SDOH_72', 'Not well'),
      ('SDOH_73', 'Not at all'),
      ('cope_a_319', 'January or February 2020'),
      ('cope_a_320', 'March or April 2020'),
      ('cope_a_321', 'May or June 2020'),
      ('cope_a_322', 'July or August 2020'),
      ('cope_a_323', 'September or October 2020'),
      ('cope_a_327', 'November or December 2020'),
      ('cope_a_334', 'Not sure, I participated in a COVID-19 vaccination trial'),
      ('cope_a_332', '1'),
      ('cope_a_333', '2'),
      ('cope_a_330', 'Pfizer (Pfizer-BioNTech)'),
      ('cope_a_331', 'Moderna'),
      ('cope_a_328', 'January or February 2021'),
      ('cope_a_242', 'Spouse, partner, boyfriend, girlfriend'),
      ('cope_a_243', 'Parent'),
      ('cope_a_244', 'Grandparent'),
      ('cope_a_245', 'Child'),
      ('cope_a_246', 'Sibling (brother or sister)'),
      ('cope_a_247', 'Co-worker'),
      ('cope_a_248', 'Friend'),
      ('cope_a_249', 'Neighbor'),
      ('cope_a_283', 'A'),
      ('cope_a_279', 'B'),
      ('cope_a_280', 'AB'),
      ('cope_a_281', 'O'),
      ('cope_a_282', 'I don\'t know my blood group for certain'),
      ('cope_a_287', 'Chills or shivers (feeling too cold)'),
      ('cope_a_289', 'Yes, some'),
      ('cope_a_326', 'No, I tried and was unable to be tested'),
      ('cope_a_325', 'Saliva sample'),
      ('cope_a_272', 'Finding a doctor (I didn\'t know where I could get the test)'),
      ('cope_a_260', 'Getting an appointment at a convenient time'),
      ('cope_a_261', 'Affording the test'),
      ('cope_a_262', 'I don\'t have insurance'),
      ('cope_a_263', 'My insurance doesn\'t cover the test'),
      ('cope_a_264', 'The insurance co-pays/deductibles were too high'),
      ('cope_a_265', 'Wait time for an available appointment'),
      ('cope_a_266', 'Taking time off from work'),
      ('cope_a_267', 'I did not have transportation'),
      ('cope_a_268', 'I did not have childcare'),
      ('cope_a_269', 'The test was not available at the doctor\'s office, clinic, or hospital'),
      ('cope_a_270', 'I did not meet criteria to be tested'),
      ('cope_a_271', 'I did not have any difficulty getting a test'),
      ('cope_a_314', 'I was experiencing COVID-19 symptoms'),
      ('cope_a_308', 'I needed to get a test for work or school'),
      ('cope_a_309', 'I needed to get a test in order to get other health care services'),
      ('cope_a_310', 'I belong to a high-risk population (e.g., have an underlying health condition)'),
      ('cope_a_311', 'I was in contact with someone who had or was suspected to have COVID-19'),
      ('cope_a_312', 'I had to comply with travel mandates (e.g., crossing state lines, international travel)'),
      ('cope_a_313', 'I had no symptoms, but testing was available'),
      ('cope_a_274', 'It is the same as before COVID-19'),
      ('cope_a_275', 'Some visits are virtual (over the phone or computer)'),
      ('cope_a_276', 'The visits are less frequent'),
      ('cope_a_277', 'I have to go to the visits alone'),
      ('cope_a_278', 'I became pregnant during COVID-19 and visits are similar'),
      ('cope_a_303', 'I will not get/am never sick.'),
      ('cope_a_290', 'It is just a virus/not fatal/not necessary.'),
      ('cope_a_291', 'I never get vaccinated.'),
      ('cope_a_292', 'I do not trust the vaccine.'),
      ('cope_a_293', 'I do not want to pay for it.'),
      ('cope_a_294', 'My region is not a high risk area.'),
      ('cope_a_295', 'Vaccination location is not convenient.'),
      ('cope_a_288', 'It depends on the risks/adverse events.'),
      ('cope_a_296', 'Vaccination is worse than being ill.'),
      ('cope_a_297', 'I have not thought about it yet.'),
      ('cope_a_298', 'I am not in a risk group with underlying conditions.'),
      ('cope_a_299', 'I need more information first.'),
      ('cope_a_300', 'It will not help.'),
      ('cope_a_301', 'I have already had COVID-19'),
      ('cope_a_302', 'I am going to let others get it first (herd immunity)'),
      ('cope_a_318', 'Very likely'),
      ('cope_a_317', 'Likely'),
      ('cope_a_273', 'I do not know yet'),
      ('cope_a_315', 'Unlikely'),
      ('cope_a_316', 'Very unlikely'),
      ('cope_a_304', 'Family gathering (wedding, graduation, funeral, etc.)'),
      ('cope_a_305', 'Religious/spiritual gathering'),
      ('cope_a_306', 'Community events (concerts, sporting events, etc.)'),
      ('cope_a_307', 'Political rally/protest'),
      ('cope_a_254', 'Much more'),
      ('cope_a_250', 'A little more'),
      ('cope_a_251', 'About the same'),
      ('cope_a_252', 'A little less'),
      ('cope_a_253', 'Much less'),
      ('cope_a_286', 'Yes, at home full time'),
      ('cope_a_284', 'Yes, at home part of the time'),
      ('cope_a_328', 'Yes, but not at home'),
      ('cope_a_285', 'No, at care, school, or college full time'),
      ('cope_a_335', 'AstraZeneca'),
      ('cope_a_336', 'Johnson & Johnson (Janssen Pharmaceuticals)'),
      ('cope_a_337', 'Swelling, redness, and/or pain at the injection site'),
      ('cope_a_338', 'Fever'),
      ('cope_a_339', 'Guillain-Barre syndrome'),
      ('cope_a_340', 'Headache'),
      ('cope_a_341', 'Tiredness'),
      ('cope_a_342', 'Muscle pain'),
      ('cope_a_343', 'Chills'),
      ('cope_a_344', 'Nausea'),
      ('cope_a_345', 'Severe allergic reaction (anaphylaxis)'),
      ('cope_a_346', 'Fainting or dizziness'),
      ('cope_a_347', 'Multisystem inflammatory syndrome'),
      ('cope_a_348', 'COVID-19 infection'),
      ('cope_a_349', 'Hospitalization'),
      ('cope_a_350', 'Other complication or event following vaccination'),
      ('cope_a_354', 'Difficulty in making an appointment'),
      ('cope_a_301', 'I have already had COVID-19.'),
      ('cope_a_302', 'I am going to let others get it first (herd immunity).'),
      ('cope_a_351', 'I have had severe allergic reactions to vaccines in the past.'),
      ('cope_a_352', 'I am concerned that it will not interact well with other medications/treatments that I am currently taking.'),
      ('cope_a_353', 'I am currently pregnant, planning a pregnancy, or breastfeeding.'),
      ('cope_a_354', 'Difficulty in making an appointment.'),
      ('cope_a_355', 'I had a severe adverse reaction to the first COVID-19 dose.'),
      ('cope_a_356', 'I know family/friends that had a severe adverse reaction to the second COVID-19 dose.'),
      ('cope_a_357', 'Myocarditis'),
      ('cope_a_358', 'Thrombocytopenia'),
      ('cope_a_361', 'Booster dose'),
      ('cope_a_362', 'Additional full dose'),
      ('cope_a_363', 'Not likely now, but maybe later'),
      ('cope_a_354', 'Difficulty making an appointment.'),
      ('cope_a_355', 'I had a severe adverse reaction to the first or second COVID-19 dose.'),
      ('cope_a_356', 'I know family/friends that had a severe adverse reaction to the first or second COVID-19 dose.'),
      ('cope_a_353', 'I am currently or planning to be pregnant or breastfeeding'),
      ('cope_a_359', 'There is not enough data on additional doses.'),
      ('cope_a_360', 'I had COVID-19 after being fully vaccinated.'),
      ('cope_a_364', 'I think I\'m sufficiently protected against COVID-19.'),
      ('cope_a_365', 'I think I should wait to get my booster until more people around the world can get vaccinated.');
      SELECT * FROM FOSPVQLIBL;"

      tmptbl_object <- bigrquery::bq_project_query(Sys.getenv("GOOGLE_PROJECT"),
                                                   query = concept_code_q
      )
      tmptbl <- dplyr::tbl(con, paste(tmptbl_object$project, tmptbl_object$dataset,
                                      tmptbl_object$table,
                                      sep = (".")
      ))
      tmp <- left_join(tmp, tmptbl, by = "value_source_value") %>%
        mutate(value_source_value = ifelse(is.na(better_answer), value_source_value, better_answer)) %>%
        select(-better_answer)
    }
